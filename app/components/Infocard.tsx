...
export default function Infocard() {
    ...
    const info = (
        <div className="p-4 text-xl flex" style={lexendPeta.style}>
            <div ref={divRefs[0]} className="infocardfast  max-h-[25]">
                <a href="tel:1-603-213-3404" className="infocardfast">603-213-3404</a>
            </div>
            &nbsp;&nbsp;
            ...
            <div ref={divRefs[1]} className="infocardfast max-h-[25]">
                <a href="https://github.com/Scapsters" className="infocardfast">github.com/Scapsters</a>
            </div>
            &nbsp;&nbsp;
            ...
            <div ref={divRefs[2]} className="infocardfast max-h-[25]">
                <a href="mailto:scotty.happy@gmail.com" className="infocardfast">scotty.happy@gmail.com</a>
            </div>
        </div>
    )
    ...
    return (
        <>
            <div className="w-full absolute h-5 -z-1 bg-[#FFFAEF]"></div>
